...
ol.renderer.webgl.VectorLayer2.prototype.renderFrame =
  ...
  */
  ...
  goog.vec.Mat4.translate(texCoordMatrix,
      (view2DState.center[0] - framebufferExtent[0]) /
          (framebufferExtent[1] - framebufferExtent[0]),
      (view2DState.center[1] - framebufferExtent[2]) /
  ...
  goog.vec.Mat4.scale(texCoordMatrix,
      view2DState.resolution / (framebufferExtent[1] - framebufferExtent[0]),
      view2DState.resolution / (framebufferExtent[3] - framebufferExtent[2]),
      1);
  goog.vec.Mat4.translate(texCoordMatrix,
      -0.5,
      -0.5,
